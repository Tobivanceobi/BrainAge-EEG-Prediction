...
test_subj = 11  # use 10 instead of 400 testing subjects, for demonstration purpose
...
train_raws[0].plot_sensors(show_names=False, kind="3d")
plt.show()
